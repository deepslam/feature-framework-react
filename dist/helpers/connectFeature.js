...
function connectFeature(callback, Component, feature, events = ["onUpdate", "onDataUpdate"]) {
    const Hoc = (ownProps) => {
...
exports.connectFeature = connectFeature;
//# sourceMappingURL=connectFeature.js.map