...
export declare function connectFeature<P extends Record<string, unknown>, F extends IFeature<any, any>>(callback: (f: F) => P, Component: React.ComponentType<P>): (model: F) => JSX.Element;
